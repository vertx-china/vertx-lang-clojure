(ns io.vertx.lang.clojure.net-server-options)
...
(defn set-client-auth-required [^NetServerOptions net-server-options client-auth-required] (.setClientAuthRequired net-server-options client-auth-required))
(defn is-client-auth-required [^NetServerOptions net-server-options] (.isClientAuthRequired net-server-options))
...
(defn set-use-pooled-buffers [^NetServerOptions net-server-options use-pooled-buffers] (.setUsePooledBuffers net-server-options use-pooled-buffers))
(defn is-use-pooled-buffers [^NetServerOptions net-server-options] (.isUsePooledBuffers net-server-options))