...
(defn create-temp-directory
  ([file-system prefix handler] (.createTempDirectory file-system prefix handler))
  ([file-system prefix perms handler] (.createTempDirectory file-system prefix perms handler))
  ([file-system dir prefix perms handler] (.createTempDirectory file-system dir prefix perms handler)))
(defn create-temp-directory-blocking
  ([file-system prefix] (.createTempDirectoryBlocking file-system prefix))
  ([file-system prefix perms] (.createTempDirectoryBlocking file-system prefix perms))
  ([file-system dir prefix perms] (.createTempDirectoryBlocking file-system dir prefix perms)))
(defn create-temp-file
  ([file-system prefix suffix handler] (.createTempFile file-system prefix suffix handler))
  ([file-system prefix suffix perms handler] (.createTempFile file-system prefix suffix perms handler))
  ([file-system dir prefix suffix perms handler] (.createTempFile file-system dir prefix suffix perms handler)))
(defn create-temp-file-blocking
  ([file-system prefix suffix] (.createTempFileBlocking file-system prefix suffix))
  ([file-system prefix suffix perms] (.createTempFileBlocking file-system prefix suffix perms))
  ([file-system dir prefix suffix perms] (.createTempFileBlocking file-system dir prefix suffix perms)))
(defn delete
