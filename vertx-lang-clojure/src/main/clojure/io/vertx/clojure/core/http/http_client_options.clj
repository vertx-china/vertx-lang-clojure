...
(defn set-key-cert-options [^HttpClientOptions http-client-options key-cert-options] (.setKeyCertOptions http-client-options key-cert-options))
...
(defn set-max-web-socket-frame-size [^HttpClientOptions http-client-options max-web-socket-frame-size] (.setMaxWebSocketFrameSize http-client-options max-web-socket-frame-size))
(defn get-max-web-socket-frame-size [^HttpClientOptions http-client-options] (.getMaxWebSocketFrameSize http-client-options))
(defn set-max-web-socket-message-size [^HttpClientOptions http-client-options max-web-socket-message-size] (.setMaxWebSocketMessageSize http-client-options max-web-socket-message-size))
(defn get-max-web-socket-message-size [^HttpClientOptions http-client-options] (.getMaxWebSocketMessageSize http-client-options))
...
(defn set-ssl-engine-options [^HttpClientOptions http-client-options ssl-engine-options] (.setSslEngineOptions http-client-options ssl-engine-options))
(defn get-ssl-engine-options [^HttpClientOptions http-client-options] (.getSslEngineOptions http-client-options))
...
(defn set-trust-options [^HttpClientOptions http-client-options trust-options] (.setTrustOptions http-client-options trust-options))
(defn get-trust-options [^HttpClientOptions http-client-options] (.getTrustOptions http-client-options))
...
(defn set-try-use-per-frame-web-socket-compression [^HttpClientOptions http-client-options try-use-per-frame-web-socket-compression] (.setTryUsePerFrameWebSocketCompression http-client-options try-use-per-frame-web-socket-compression))
(defn set-try-use-per-message-web-socket-compression [^HttpClientOptions http-client-options try-use-per-message-web-socket-compression] (.setTryUsePerMessageWebSocketCompression http-client-options try-use-per-message-web-socket-compression))
(defn get-try-use-per-message-web-socket-compression [^HttpClientOptions http-client-options] (.getTryUsePerMessageWebSocketCompression http-client-options))
(defn get-try-web-socket-deflate-frame-compression [^HttpClientOptions http-client-options] (.getTryWebSocketDeflateFrameCompression http-client-options))
...
(defn set-web-socket-compression-allow-client-no-context [^HttpClientOptions http-client-options web-socket-compression-allow-client-no-context] (.setWebSocketCompressionAllowClientNoContext http-client-options web-socket-compression-allow-client-no-context))
(defn get-web-socket-compression-allow-client-no-context [^HttpClientOptions http-client-options] (.getWebSocketCompressionAllowClientNoContext http-client-options))
(defn set-web-socket-compression-level [^HttpClientOptions http-client-options web-socket-compression-level] (.setWebSocketCompressionLevel http-client-options web-socket-compression-level))
(defn get-web-socket-compression-level [^HttpClientOptions http-client-options] (.getWebSocketCompressionLevel http-client-options))
(defn set-web-socket-compression-request-server-no-context [^HttpClientOptions http-client-options web-socket-compression-request-server-no-context] (.setWebSocketCompressionRequestServerNoContext http-client-options web-socket-compression-request-server-no-context))
(defn get-web-socket-compression-request-server-no-context [^HttpClientOptions http-client-options] (.getWebSocketCompressionRequestServerNoContext http-client-options))
