...
(defn stream-priority
  ([http-server-request] (.streamPriority http-server-request)))
(defn stream-priority-handler
  ([http-server-request handler] (.streamPriorityHandler http-server-request handler)))
(defn upgrade
