...
(defn get-local-async-map
  ([shared-data name result-handler] (.getLocalAsyncMap shared-data name result-handler)))
(defn get-local-counter
  ([shared-data name result-handler] (.getLocalCounter shared-data name result-handler)))
(defn get-local-lock
  ([shared-data name result-handler] (.getLocalLock shared-data name result-handler)))
(defn get-local-lock-with-timeout
  ([shared-data name timeout result-handler] (.getLocalLockWithTimeout shared-data name timeout result-handler)))
(defn get-local-map
