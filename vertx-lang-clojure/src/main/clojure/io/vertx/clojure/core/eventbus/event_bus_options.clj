...
(defn set-ssl-engine-options [^EventBusOptions event-bus-options ssl-engine-options] (.setSslEngineOptions event-bus-options ssl-engine-options))
(defn get-ssl-engine-options [^EventBusOptions event-bus-options] (.getSslEngineOptions event-bus-options))
...
(defn set-trust-options [^EventBusOptions event-bus-options trust-options] (.setTrustOptions event-bus-options trust-options))
(defn get-trust-options [^EventBusOptions event-bus-options] (.getTrustOptions event-bus-options))
