...
(defn set-ssl-engine-options [^TCPSSLOptions t-cpssl-options ssl-engine-options] (.setSslEngineOptions t-cpssl-options ssl-engine-options))
(defn get-ssl-engine-options [^TCPSSLOptions t-cpssl-options] (.getSslEngineOptions t-cpssl-options))
...
(defn set-trust-options [^TCPSSLOptions t-cpssl-options trust-options] (.setTrustOptions t-cpssl-options trust-options))
(defn get-trust-options [^TCPSSLOptions t-cpssl-options] (.getTrustOptions t-cpssl-options))
