...
(defn set-key-cert-options [^NetClientOptions net-client-options key-cert-options] (.setKeyCertOptions net-client-options key-cert-options))
...
(defn set-ssl-engine-options [^NetClientOptions net-client-options ssl-engine-options] (.setSslEngineOptions net-client-options ssl-engine-options))
(defn get-ssl-engine-options [^NetClientOptions net-client-options] (.getSslEngineOptions net-client-options))
...
(defn set-trust-options [^NetClientOptions net-client-options trust-options] (.setTrustOptions net-client-options trust-options))
(defn get-trust-options [^NetClientOptions net-client-options] (.getTrustOptions net-client-options))
