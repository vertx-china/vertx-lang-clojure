...
(defn set-key-cert-options [^ClientOptionsBase client-options-base key-cert-options] (.setKeyCertOptions client-options-base key-cert-options))
...
(defn set-ssl-engine-options [^ClientOptionsBase client-options-base ssl-engine-options] (.setSslEngineOptions client-options-base ssl-engine-options))
(defn get-ssl-engine-options [^ClientOptionsBase client-options-base] (.getSslEngineOptions client-options-base))
(defn set-ssl-handshake-timeout [^ClientOptionsBase client-options-base ssl-handshake-timeout] (.setSslHandshakeTimeout client-options-base ssl-handshake-timeout))
(defn get-ssl-handshake-timeout [^ClientOptionsBase client-options-base] (.getSslHandshakeTimeout client-options-base))
(defn set-ssl-handshake-timeout-unit [^ClientOptionsBase client-options-base ssl-handshake-timeout-unit] (.setSslHandshakeTimeoutUnit client-options-base ssl-handshake-timeout-unit))
(defn get-ssl-handshake-timeout-unit [^ClientOptionsBase client-options-base] (.getSslHandshakeTimeoutUnit client-options-base))
...
(defn set-trust-options [^ClientOptionsBase client-options-base trust-options] (.setTrustOptions client-options-base trust-options))
(defn get-trust-options [^ClientOptionsBase client-options-base] (.getTrustOptions client-options-base))
