...
(defn fetch
  ([http-client-request amount] (.fetch http-client-request amount)))
(defn get-host
...
(defn pipe
  ([http-client-request] (.pipe http-client-request)))
(defn pipe-to
  ([http-client-request dst] (.pipeTo http-client-request dst))
  ([http-client-request dst handler] (.pipeTo http-client-request dst handler)))
(defn push-handler
