...
(defn set-tracing-options [^VertxOptions vertx-options tracing-options] (.setTracingOptions vertx-options tracing-options))
(defn get-tracing-options [^VertxOptions vertx-options] (.getTracingOptions vertx-options))
...
(defn to-json [^VertxOptions vertx-options] (.toJson vertx-options))